...
public class DBUserTableCreator {
    ...
    public static void createUserTable() {
        ...
        try {
            ...
            String sql = "CREATE TABLE CustomerData (consumerId BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 1234567890123, INCREMENT BY 1),billNo BIGINT UNIQUE,title VARCHAR(10),name VARCHAR(50),email VARCHAR(100),countryCode VARCHAR(20),mobile BIGINT,address VARCHAR(250),userId VARCHAR(50),password VARCHAR(50),status VARCHAR(20))";
