...
%>
<%@ page import="java.util.*, bean.CustomerData" %>
...
<% } else { %>
    <table>
        ...
        <% for (int i = 0; i < users.size(); i++) {
            CustomerData c = users.get(i);
        %>
        <tr>
            <td><%= c.getNewcustId() %></td>
            <td><%= c.getCustName() %></td>
            <td><%= c.getCountryCode() + " " + c.getMobile() %></td>
            <td><%= c.getEmail() %></td>
            <td>
...
<div id="popupModal">
    <div class="popup-content">
        ...
        <div id="updateSection">
            <form id="confirmId" method="post" action="ConfirmNewUser">
                <input type="hidden" id="hiddenId" name="Id" />
                <input type="submit" value="Accept"/>
            </form>
            <form id="RejectId" method="post" action="<%=request.getContextPath()%>/">
                <input type="hidden" id="hiddenId" name="Id" />
...
newusers.push({
    ...
    mobile: "<%= c.getMobile() %>",
    address: <%= "\"" + c.getAddress().replace("\\", "\\\\").replace("\"", "\\\"").replace("\n", " ").replace("\r", " ") + "\"" %>
